...
try{  
pool.query("insert into employees(employeename, dob, gender, address, stateid, cityid, department, grade, salary, picture)values(?,?,?,?,?,?,?,?,?,?)",[req.body.employeename, req.body.dob, req.body.gender, req.body.address, req.body.stateid, req.body.cityid, req.body.department, req.body.grade, req.body.salary, req.file.filename],function(error,result){
  if(error){
  ...
  {
     res.render("employeeform",{status:true,message:"Employee Submitted Successfully",color:'green'})
  }
})
}
catch(e)
{
     res.render("employeeform",{status:false,message:"Some Critical Error, Contanct to Backend Team....",color:'red'})
}
...
try{
  ...
  {   
pool.query("update employees set employeename=?, dob=?, gender=?, address=?, stateid=?, cityid=?, department=?, grade=?, salary=? where employeeid=?",[req.body.employeename, req.body.dob, req.body.gender, req.body.address, req.body.stateid, req.body.cityid, req.body.department, req.body.grade, req.body.salary, req.body.employeeid],function(error,result){
  if(error){
    console.log(error)
